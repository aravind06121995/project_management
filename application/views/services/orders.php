...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
        <ul class="dropdown-menu small-text" style="min-width: 90px !important; left: -90px;">
          ...
          <li><a href="#" onclick="change_search(3)"><span class="glyphicon glyphicon-ok no-display" id="email-exact"></span> <?php echo lang("ctn_24") ?></a></li>
...
<thead>
<tr class="table-header"><td><?php echo lang("ctn_1245") ?></td><td><?php echo lang("ctn_357") ?></td><td><?php echo lang("ctn_24") ?></td><td><?php echo lang("ctn_261") ?></td><td><?php echo lang("ctn_1246") ?></td><td><?php echo lang("ctn_70") ?></td><td><?php echo lang("ctn_52") ?></td></tr>
</thead>
<tbody>
</tbody>
</table>
   ...
   var st = $('#search_type').val();
    var table = $('#services-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("services/orders_page") ?>",
            type : 'GET',
            data : function ( d ) {
