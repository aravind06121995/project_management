...
<!-- changes made by Aravind @26/06/2020 -->
<!-- In previous it as permission to create a project for project_worker role, has_permissions(array("admin", "project_admin", "project_worker") -->


    <?php if($this->common->has_permissions(array("admin", "project_admin"), $this->user)) : ?><button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"><?php echo lang("ctn_785") ?></button><?php endif; ?>
</div>
</div>
