...
<!-- restrict the task_worker to Add Member for an task ($this->common->has_permissions(array("admin", "project_admin", "task_manage", "task_worker"), $this->user)) -->

<div class="white-area-content content-separator">
<div class="db-header clearfix">
    <div class="task-header-title"> <span class="glyphicon glyphicon-user"></span> <?php echo lang("ctn_867") ?></div>
    <div class="db-header-extra"> <?php if($this->common->has_permissions(array("admin", "project_admin", "task_manage"), $this->user)) : ?><button data-toggle="modal" data-target="#addMemberModal" class="btn btn-primary btn-xs"><?php echo lang("ctn_868") ?></button> <?php endif; ?> </div>
</div>
