...
<!-- used to hide the nav bar for view_file modal page by getting the url -->
<?php 
  if( strpos(strtolower($_SERVER['REQUEST_URI']),'project_management/index.php/files/view_file') ===false ) {
?>
  ...
  if( strpos(strtolower($_SERVER['REQUEST_URI']),'project_management/index.php/files/view_file') ===false) {
?>
  <!-- used to remove the id main-content for particular page by getting the url, it cause an error like space occupy with white space  -->
    <div id="main-content">
    <?php } else { ?>
      <div>
...
<?php } ?>
    ...
    <!-- want to hide the footer for viewfile modal dropdown page page -->
    <?php 
  if( strpos(strtolower($_SERVER['REQUEST_URI']),'project_management/index.php/files/view_file') ===false) {
  ?>
