            ...
            <?php if($this->settings->info->enable_tasks && $this->common->has_permissions(array("admin", "project_admin", "task_worker", "task_manage", "task_client"), $this->user)) : ?>
              <li id="task_links">
                  ...
                  <div id="task_links_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['task'])) echo "in" ?>">
                    ...
                    <?php endif; ?>
<!-- change made by Aravind @26/06/2020 -->
<!-- make template submenu visible for admin only -->
                     <?php if($this->common->has_permissions(array("admin", "project_admin", "task_manage", "task_worker"), $this->user)) : ?>
            ...
            <?php if($this->settings->info->enable_files && $this->common->has_permissions(array("admin", "project_admin", "file_worker", "file_manage"), $this->user)) : ?>
              <li id="file_links">
                  ...
                  <div id="file_links_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['file'])) echo "in" ?>">
                    <ul class="inner-sidebar-links">
            <!-- your project file option remove from all user except admin, before that if($this->common->has_permissions(array("admin", "project_admin", "file_manage"), $this->user))  -->
                      ...
                      <?php endif; ?>
                        ...
                        <li class="<?php if(isset($activeLink['file']['restore'])) echo "active" ?>"><a href="<?php echo site_url("files/restore")?>"> <?php echo lang("ctn_1620") ?></a></li>
            ...
            <?php endif; ?>
            <?php if($this->settings->info->enable_files && $this->common->has_permissions(array("admin", "project_admin", "file_worker", "file_manage"), $this->user)) : ?>
              <li id="file_links_tech">
                  <a data-toggle="collapse" data-parent="#file_links_tech" href="#file_links_tech_c" class="collapsed <?php if(isset($activeLink['technical'])) echo "active" ?>" >
                    <span class="glyphicon glyphicon-file sidebar-icon sidebar-icon-brown"></span> <?php echo "Technical Document" ?>
                    <span class="plus-sidebar"><span class="glyphicon <?php if(isset($activeLink['file'])) : ?>glyphicon-menu-down<?php else : ?>glyphicon-menu-right<?php endif; ?>"></span></span>
                  </a>
                  <div id="file_links_tech_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['technical'])) echo "in" ?>">
                    <ul class="inner-sidebar-links">
            <!-- your project file option remove from all user except admin, before that if($this->common->has_permissions(array("admin", "project_admin", "file_manage"), $this->user))  -->
                      <?php if($this->common->has_permissions(array("admin"), $this->user)) : ?>
                      <li class="<?php if(isset($activeLink['technical']['general'])) echo "active" ?>"><a href="<?php echo site_url("technical") ?>"> <?php echo lang("ctn_701") ?></a></li>
                      <?php endif; ?>
                        <li class="<?php if(isset($activeLink['technical']['all'])) echo "active" ?>"><a href="<?php echo site_url("technical/all") ?>"> <?php echo lang("ctn_702") ?></a></li>
                        <li class="<?php if(isset($activeLink['technical']['restore'])) echo "active" ?>"><a href="<?php echo site_url("technical/restore")?>"> <?php echo lang("ctn_1620") ?></a></li>
              ...
              <li id="team_links">
                  ...
                  <div id="team_links_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['team'])) echo "in" ?>">
                    <ul class="inner-sidebar-links">
                      ...
                      <?php endif; ?>
                      <?php if($this->common->has_permissions(array("admin"), $this->user)) : ?>
                        <!-- change done by Aravind @26/06/2020 -->
                        ...
                        <!-- That above client option show for all user, but for now i have made it to visible for admin -->
                      <?php endif; ?>
                     <!--  <li class="<?php if(isset($activeLink['team']['clients'])) echo "active" ?>"><a href="<?php echo site_url("team/clients") ?>"> <?php echo lang("ctn_1469") ?></a></li> -->
                    </ul>
                  </div>
            ...
            <?php if($this->settings->info->enable_tickets && $this->common->has_permissions(array("admin", "project_admin", "ticket_worker", "ticket_manage", "ticket_client"), $this->user)) : ?>
              <li id="tickets_links">
                  <a data-toggle="collapse" data-parent="#tickets_links" href="#tickets_links_c" class="collapsed <?php if(isset($activeLink['tickets'])) echo "active" ?>" >
                    <span class="glyphicon glyphicon-send sidebar-icon sidebar-icon-green"></span> <?php echo lang("ctn_1621") ?>
              ...
              <li id="doc_links">
                  ...
                  <div id="doc_links_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['doc'])) echo "in" ?>">
                    <ul class="inner-sidebar-links">
                      ...
                      <?php endif; ?>
                      <!-- That above client option show for all user, but for now make it to visible for admin -->
              ...
              <li id="quote_links">
                  ...
                  <div id="reports_links_c" class="panel-collapse collapse sidebar-links-inner <?php if(isset($activeLink['reports'])) echo "in" ?>">
                    <ul class="inner-sidebar-links">
                      ...
                      <?php endif; ?>
                      <!-- That above Time, Finance,Invoice option show for all user, but for now make it to visible for admin -->
                     
                    </ul>
                  </div>
              </li>
            <?php endif; ?>
            <li class="<?php if(isset($activeLink['attendance']['user'])) echo "active" ?>"><a href="<?php echo site_url("attendance/user") ?>"><span class="glyphicon glyphicon-oil sidebar-icon sidebar-icon-red"></span> <?php echo lang("ctn_1624") ?></a></li>          
