...
<div class="form-group">
    <label for="dpname-in" class="col-sm-2 control-label"><?php echo lang("ctn_1593") ?></label>
    <div class="col-sm-10">
        <input type="checkbox" name="enable_stock" value="1" <?php if($this->settings->info->enable_stock) echo "checked" ?> /> <?php echo lang("ctn_353") ?>
    </div>
</div>
