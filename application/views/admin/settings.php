...
<div class="form-group">
            <label for="copyright_footer" class="col-sm-2 control-label">Copyright Footer</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="copyright_footer" name="copyright_footer" placeholder="" value="<?php echo html_escape($this->settings->info->copyright_footer) ?>">
                <span class="help-block">Change the copyright text that appears in the footer on the site.</span>
            </div>
</div>
<div class="form-group">
