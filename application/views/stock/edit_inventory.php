...
<?php echo form_open(site_url("stock/edit_inventory_pro/" . $inventory->ID), array("class" => "form-horizontal")) ?>
            <div class="form-group">
                    ...
                    <div class="col-md-8 ui-front">
                        ...
                        <?php foreach($projects->result() as $r) : ?>
                          <option value="<?php echo $r->ID ?>" <?php if($inventory->projectid == $r->ID) echo "selected" ?>><?php echo $r->name ?></option>
                        <?php endforeach; ?>
                        </select>
                    </div>
            </div>
                    ...
                    <div class="col-md-8">
                        <select name="stockid" class="form-control" id="item-load">
                        	...
                        	<?php foreach($items->result() as $r) : ?>
                        		<option value="<?php echo $r->ID ?>" <?php if($r->ID == $inventory->itemid) echo "selected" ?>><?php echo $r->name ?></option>
                        	<?php endforeach; ?>
                        </select>
            ...
            <div class="form-group">
                    ...
                    <div class="col-md-8 ui-front">
                        <input type="text" class="form-control" name="price" value="<?php echo $inventory->price ?>" id="price">
                    </div>
            </div>
            <div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_261") ?></label>
                    <div class="col-md-8 ui-front">
                        <input type="text" class="form-control" name="cost" value="<?php echo $inventory->cost ?>" id="cost">
                    </div>
            </div>
            <div class="form-group">
                    <label for="p-in" class="col-md-4 label-heading"><?php echo lang("ctn_752") ?></label>
                    <div class="col-md-8 ui-front">
                        <input type="text" class="form-control" name="note" value="<?php echo $inventory->note ?>">
                    </div>
            </div>
