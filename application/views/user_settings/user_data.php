...
<ol class="breadcrumb">
  ...
  <li class="active"><?php echo lang("ctn_1511") ?></li>
</ol>

<div class="panel panel-default">
  	<div class="panel-body">
  	<?php echo form_open(site_url("user_settings/user_data_pro"), array("class" => "form-horizontal")) ?>
  			<div class="form-group">
			    <label for="inputEmail3" class="col-sm-2 control-label"><?php echo lang("ctn_1505") ?></label>
			    <div class="col-sm-10">
			      <input type="text" name="company_name" class="form-control" value="<?php echo $user_data->company_name ?>">
			    </div>
			</div>
			<div class="form-group">
			    <label for="inputEmail3" class="col-sm-2 control-label"><?php echo lang("ctn_1506") ?></label>
			    <div class="col-sm-10">
			      <input type="text" name="phone" class="form-control" value="<?php echo $user_data->phone ?>">
			    </div>
			</div>
			<div class="form-group">
			    <label for="inputEmail3" class="col-sm-2 control-label"><?php echo lang("ctn_1392") ?></label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" name="website" value="<?php echo $user_data->website ?>">
			    </div>
			</div>
			<p class="panel-subheading"><?php echo lang("ctn_1387") ?></p>
            <div class="form-group">
			    <label for="inputEmail3" class="col-sm-2 control-label"><?php echo lang("ctn_1388") ?></label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" name="twitter" value="<?php echo $user_data->twitter ?>">
			    </div>
			</div>
			<div class="form-group">
			    <label for="inputEmail3" class="col-sm-2 control-label"><?php echo lang("ctn_1389") ?></label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" name="facebook" value="<?php echo $user_data->facebook ?>">
			    </div>
			</div>
			<div class="form-group">
			    <label for="inputEmail3" class="col-sm-2 control-label"><?php echo lang("ctn_1390") ?></label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" name="google" value="<?php echo $user_data->google ?>">
			    </div>
			</div>
			<div class="form-group">
			    <label for="inputEmail3" class="col-sm-2 control-label"><?php echo lang("ctn_1391") ?></label>
			    <div class="col-sm-10">
