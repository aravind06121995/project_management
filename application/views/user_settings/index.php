...
<!-- on v0 this part is visible for all user, but in v1 it is visible for admin user only -->
    <?php if($this->common->has_permissions(array("admin"), $this->user)) : ?>
    	<a href="<?php echo site_url("user_settings/user_data") ?>" class="btn btn-info btn-sm"><?php echo lang("ctn_1511") ?></a> <a href="<?php echo site_url("user_settings/paying_account") ?>" class="btn btn-info btn-sm"><?php echo lang("ctn_1329") ?></a> <a href="<?php echo site_url("user_settings/social_networks") ?>" class="btn btn-primary btn-sm"><?php echo lang("ctn_1615") ?></a>
    <?php endif; ?>
</div>
</div>
