...
<!-- add a download function while click on download link for an image, on previous they only had zoom an image -->
<tr><td><?php echo lang("ctn_496") ?></td><td><a href="<?php echo $url ?>" download><?php echo basename($url) ?></a></td></tr>
...
<a href="<?php echo site_url("technical/delete_file_note/" . $r->ID . "/" . $this->security->get_csrf_hash()) ?>"><?php echo lang("ctn_503") ?></a>
<?php endif; ?>
</div>
...
<h4><?php echo lang("ctn_504") ?></h4>
 <?php echo form_open(site_url("technical/add_file_note/" . $file->ID), array("class" => "form-horizontal")) ?>
