...
<div class="db-header clearfix">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
      <li><a href="<?php echo site_url("technical/" . $page) ?>"><?php echo lang("ctn_449") ?></a></li>
      <li><a href="<?php echo site_url("technical/" . $page . "/0/0") ?>"><?php echo lang("ctn_483") ?></a></li>
    <?php foreach($projects->result() as $r) : ?>
      <li><a href="<?php echo site_url("technical/".$page."/0/" . $r->ID) ?>"><?php echo $r->name ?></a></li>
    <?php endforeach; ?>
  </ul>
</div>
</div>
...
<span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
    ...
    <!-- 
      <a href="<?php echo site_url("technical/add_file/" . $folder_parent) ?>" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal"><?php echo lang("ctn_486") ?></a> 
    -->
                 ...
                 <script type="text/javascript">
                  $(document).ready(function() {
                      $('#project-select').change(function() {
                          ...
                          $.ajax({
                              url: global_base_url + 'technical/get_folders_for_project/',
                              type: 'GET',
                              data: {
                                  projectid : projectid
                              },
...
<table id="technical-table" class="table table-bordered table-hover">
<thead>
...
$(document).ready(function() {
   ...
   var st = $('#search_type').val();
    var table = $('#technical-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("technical/file_page/" . $page . "/" . $folder_parent . "/" . $projectid ) ?>",
            type : 'GET',
            data : function ( d ) {
