<div class="white-area-content">
  ...
  <ol class="breadcrumb">
    ...
    <?php else : ?>
      <li><a href="<?php echo site_url("technical/restore") ?>"><?php echo lang("ctn_487") ?></a></li>
    <?php endif; ?>
  ...
  <!-- getting the data from controller technical.php -->
  <div id="gallery"></div> 
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
      $.ajax({
        url: "<?php echo site_url("technical/file_restore_page/" . $page . "/" . $folder_parent . "/" . $projectid ) ?>",
        type : 'GET'
      }).done(function(data){
        $("#gallery").html(data);
      })
    ...
    $(document).on("click", ".zoom-img-open", function () {
      //getting sorce file name & id in array on data-id, by using split can get the value in array format 
       ...
       var zoomdeslink = '/project_management/index.php/technical/view_file/'+zoomImg[1];
       // alert(zoomImg[1]);
