...
<div class="db-header clearfix">
    <div class="page-header-title"> <span class="glyphicon glyphicon-credit-card"></span> <?php echo lang("ctn_1594") ?></div>
   ...
   var st = $('#search_type').val();
    var table = $('#invoices-table').DataTable({
      ...
      "processing": false,
        ...
        "ajax": {
            url : "<?php echo site_url("invoices/estimate_page/".$page."/0/" . $projectid) ?>",
            type : 'GET',
            data : function ( d ) {
