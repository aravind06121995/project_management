        ...
        <?php if(!empty($invoice->email)) : ?><br /><?php echo $invoice->email ?><br /><?php endif; ?>
            ...
            <?php endforeach; ?>
                    ...
                    <table class="table"><tr><td>
                         <?php if($invoice->estimate) : ?>
                <div class="btn-group">
  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
   <span id="estimate_status">
     <?php if($invoice->estimate_status == 0) : ?><?php echo lang("ctn_1611") ?><?php elseif($invoice->estimate_status == 1) : ?><?php echo lang("ctn_1612") ?><?php elseif($invoice->estimate_status == 2) : ?><?php echo lang("ctn_1613") ?><?php endif; ?></span> <span class="caret"></span>
  </button>
  <ul class="dropdown-menu">
    <li><a href="#" onclick="change_status(0)"><?php echo lang("ctn_1611") ?></a></li>
    <li><a href="#" onclick="change_status(1)"><?php echo lang("ctn_1612") ?></a></li>
    <li><a href="#" onclick="change_status(2)"><?php echo lang("ctn_1613") ?></a></li>
  </ul>
</div>
                <?php else : ?>
...
{
     $.ajax({
        url: global_base_url + "invoices/estimate_status/<?php echo $invoice->ID ?>/<?php echo $invoice->hash ?>",
        data: { 
            status : status
        },
        success: function(msg) {
