		...
		foreach ($rs->result() as $r) {
			...
			if($type == 'document') {
				 echo " <div class='orderlist'>
					...
					<div class='row'>
						<div class='column'>
                		<a class='lightbox' href='/project_management/uploads/$upload_file_name' target='_blank'>
                		<div class='orderlist1'>
                   			<img src='/project_management/images/document.png' alt='' class='image' height='150px' width='150px'>
			...
			echo "	<div id='$lid' class='orderlist'>
					<ul class='tz-gallery'>
					<div class='row'>
					<div class='column'>
                 	<a class='lightbox' href='/project_management/index.php/files/$page/$r->ID/$projectid/'>
                 	<div class='orderlist1'>
						<img src='/project_management/images/folder.jpg' class='image' alt='folder' height='150px' width='150px'/>
