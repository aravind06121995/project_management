<div class="container">
    ...
    <!-- want to set a form height on login_layout.css , before that on login_layout.css line no.25 min-height=450px -->
    ...
    <!-- this is for register and forgot password -->
    ...
    <!-- this is for social media button on the bottom -->
